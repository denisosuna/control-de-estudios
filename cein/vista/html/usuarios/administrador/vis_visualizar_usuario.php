...
<link href="../../../css/usuarios/administrador/visualizar_usuario.css" rel="stylesheet" type="text/css"><!-- estilo unico de esta pagina -->
...
<div class="contenedor">
  ...
  <div class="contenido">
	...
	echo "<div class='botones'>";
echo " <input class='button ' type='submit' name='enviar' id='enviar' value='ver_registro' ></div></td>";
